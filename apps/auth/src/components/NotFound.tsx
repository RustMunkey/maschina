...
export function NotFound() {
  return (
    <div className="min-h-dvh bg-black flex flex-col">
      {/* Noise — clipped to content area only (inside header, footer, dividers) */}
      <div
        aria-hidden
        style={{
          position: "fixed",
      ...
      <main id="main-content" tabIndex={-1} className="flex-1 flex flex-col items-center justify-center px-5 pt-16 pb-16 text-center outline-none" style={{ position: "relative", zIndex: 2 }}>
        <div className="relative px-20 py-16 flex flex-col items-center">
          ...
          <p className="text-[120px] font-bold leading-none tracking-tighter text-[#F84242]/10 select-none" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>404</p>
          <h1 className="text-2xl font-semibold tracking-tight text-white mt-2">Page not found.</h1>
          <p className="mt-2 text-sm text-white/30">This page doesn't exist or was moved.</p>
