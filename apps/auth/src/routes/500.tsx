    ...
    <div className="min-h-dvh bg-black flex flex-col">
      ...
      <main id="main-content" tabIndex={-1} className="flex-1 flex flex-col items-center justify-center px-5 pt-16 pb-16 text-center outline-none" style={{ position: "relative", zIndex: 2 }}>
        <div className="relative px-20 py-16 flex flex-col items-center">
          ...
          <p className="text-[120px] font-bold leading-none tracking-tighter text-[#F84242]/10 select-none" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>500</p>
          <h1 className="text-2xl font-semibold tracking-tight text-white mt-2">Server error.</h1>
          <p className="mt-2 text-sm text-white/30">Something went wrong on our end. Try again shortly.</p>
