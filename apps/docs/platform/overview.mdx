...
- **Community nodes** — hardware contributed by node operators in exchange for network incentives
...
<Network size={18} weight="duotone" style={{display:"inline",verticalAlign:"middle",marginRight:"6px"}} />**Decentralization.** As the network matures, compute ownership will shift from centralized providers to a distributed network of node operators, reducing single points of failure and enabling competitive compute pricing.
