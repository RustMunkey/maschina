...
| **Node Runners** | Contribute compute | Earn rewards for verified work |
...
- <Coins size={16} weight="duotone" style={{display:"inline",verticalAlign:"middle",marginRight:"6px"}} />Stake to participate as a node runner
...
flowchart TD
    ...
    Protocol -->|compute cost| Node[Node Runner]
...
- Early node runners receive higher emission rates as network bootstrap incentives
...
pie title Network Fee Distribution
    "Compute Rewards (Node Runners)" : 40
...
|---|---|---|
| Compute rewards pool | 40% | Distributed to node runners per verified job |
