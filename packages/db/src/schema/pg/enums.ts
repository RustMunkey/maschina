...
// ─── Plans / Billing ─────────────────────────────────────────────────────────
export const planTierEnum = pgEnum("plan_tier", ["access", "m1", "m5", "m10", "teams", "enterprise", "internal"]);
...
export const agentTypeEnum = pgEnum("agent_type", [
  "signal", "analysis", "execution", "optimization", "reporting",
]);
export const agentStatusEnum = pgEnum("agent_status", [
  "idle", "scanning", "evaluating", "executing", "analyzing", "scaling", "error", "stopped",
]);

// ─── Usage ────────────────────────────────────────────────────────────────────
export const usageEventTypeEnum = pgEnum("usage_event_type", [
  "api_call", "agent_execution", "model_inference", "storage_read", "storage_write",
]);

// ─── Infrastructure ───────────────────────────────────────────────────────────
export const jobStatusEnum = pgEnum("job_status", [
  "pending", "running", "completed", "failed", "canceled", "retrying",
]);
...
export const notificationTypeEnum = pgEnum("notification_type", [
  ...
  "usage_quota_warning", "usage_quota_exceeded",
  "billing_payment_failed", "billing_invoice_ready",
  "team_invite_received", "team_member_joined",
  "system_announcement",
]);
